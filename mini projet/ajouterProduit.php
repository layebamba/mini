...
<div class="container">
    ...
    <input type="submit" class="login" value="validez pour ajoutez" name="ok">
...
for($i=0;$i<$lignes;$i++){
  ...
  if ($_POST['quantite']<=10) {
    echo'<tr><th class="p-3 mb-2 bg-danger text-white">'.$_POST['nom'].'</th>'; 
  
    echo'<th class="p-3 mb-2 bg-danger text-white">'. $_POST['quantite']. '</th>';

   echo'<th class="p-3 mb-2 bg-danger text-white">'.$_POST['prix']. '</th>';

  echo '<th class="p-3 mb-2 bg-danger text-white">' .$_POST['prix']* $_POST['quantite'].'</th></tr>';
  }
  else {
    echo'<tr><th>'.$_POST['nom'].'</th>'; 
    echo'<th >'. $_POST['quantite']. '</th>';
     echo'<th>'.$_POST['prix']. '</th>';
