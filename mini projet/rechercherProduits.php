...
<form class="form3" action="" method="post">
 ...
 <input type="number" name="min" id="" placeholder="prix min">
 <input type="number" name="max" id=""placeholder="prix max">
<input class="login" type="submit" name="recherchez" value="recherchez">  <br> <br>
</form>
</div>
...
<tbody>';
    ...
    for($i=0;$i<$lignes;$i++){
        echo '<tr>';
        if ($_POST['Quantite']<=$produits[$i][1] && $_POST['Quantite'] !="" ) {
            if($produits[$i][1]<10){
                for($j=0;$j<$colonne;$j++){
        ...
        else if ($_POST['min']<=$produits[$i][2] && $_POST['min'] !="" ) {
            if($produits[$i][1]<10){
                for($j=0;$j<$colonne;$j++){
                    echo   '<th class="p-3 mb-2 bg-danger text-white">'.$produits[$i][$j].'</th>';
                }
        ...
        else if ($_POST['max']>=$produits[$i][2] && $_POST['max'] !="" ) {
            if($produits[$i][1]<10){
                for($j=0;$j<$colonne;$j++){
                    echo   '<th class="p-3 mb-2 bg-danger text-white">'.$produits[$i][$j].'</th>';
                }
